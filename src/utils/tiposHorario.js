...
export const DEFAULT_TIPOS_HORARIO = [
  { key: 'personalizado', label: 'Presencial', icon: 'Work', color: '#00830e', template: TIPO_TEMPLATES.SIMPLE, noSumaHoras: false, orden: 1, editable: false },
  { key: 'teletrabajo', label: 'Teletrabajo', icon: 'HomeWork', color: '#2e7d32', template: TIPO_TEMPLATES.SIMPLE, noSumaHoras: false, orden: 2, editable: false },
  { key: 'tele-presencial', label: 'Teletrabajo & Presencial', icon: 'SyncAlt', color: '#6a1b9a', template: TIPO_TEMPLATES.TELE_PRESENCIAL, noSumaHoras: false, orden: 3, editable: false },
  { key: 'horario-dividido', label: 'Horario Dividido', icon: 'AccessTime', color: '#7c3aed', template: TIPO_TEMPLATES.HORARIO_DIVIDIDO, noSumaHoras: false, orden: 4, editable: false },
  { key: 'visita-comercial', label: 'Visita Comercial', icon: 'Business', color: '#795548', template: TIPO_TEMPLATES.SIMPLE, noSumaHoras: false, orden: 5, editable: false },
  { key: 'cambio', label: 'Cambio', icon: 'SwapHoriz', color: '#f57c00', template: TIPO_TEMPLATES.SIMPLE, noSumaHoras: false, orden: 6, editable: false },
  { key: 'descanso', label: 'Descanso', icon: 'EventBusy', color: '#64748b', template: TIPO_TEMPLATES.SIN_HORAS, noSumaHoras: true, orden: 7, editable: false },
  { key: 'vacaciones', label: 'Vacaciones', icon: 'BeachAccess', color: '#f97316', template: TIPO_TEMPLATES.SIN_HORAS, noSumaHoras: true, orden: 8, editable: false },
  { key: 'feriado', label: 'Feriado', icon: 'Celebration', color: '#ef4444', template: TIPO_TEMPLATES.SIN_HORAS, noSumaHoras: true, orden: 9, editable: false },
  ...
  { key: 'incapacidad-enfermedad', label: 'Incapacidad por Enfermedad', icon: 'LocalHospital', color: '#d32f2f', template: TIPO_TEMPLATES.SIN_HORAS, noSumaHoras: true, orden: 18, editable: false },
  { key: 'incapacidad-accidente', label: 'Incapacidad por Accidente', icon: 'Healing', color: '#c62828', template: TIPO_TEMPLATES.SIN_HORAS, noSumaHoras: true, orden: 19, editable: false }
];
